package com.twitter.streaming.kafka.consumer.config;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<K, V>> kafkaListenerContainerFactory() {
        ...
        factory.setBatchListener(kafkaConsumerConfigData.getBatchListener()); // create batch listeners in new threads
        factory.setConcurrency(kafkaConsumerConfigData.getConcurrencyLevel()); // one thread per partition
